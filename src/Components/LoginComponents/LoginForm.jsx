...
const LoginForm = ({ onToggleAuth }) => {
  return (
    <div className="p-12 md:w-3/5 relative h-screen md:h-auto overflow-y-auto">
      ...
      <form className="space-y-8 max-w-2xl mx-auto font-poppins" onSubmit={(e) => e.preventDefault()}>
        <div>
        ...
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="text-base text-orange-600 hover:text-orange-500 transition-colors">
            Forgot password?
          </a>
        </div>
